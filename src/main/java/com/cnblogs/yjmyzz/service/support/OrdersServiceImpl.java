...
public class OrdersServiceImpl extends BaseServiceImpl implements OrderService {
	...
	public Order get(String id) {
		...
		// return OrderConverter.toDto(tOrderDAO.get(TOrder.class, new
		// BigDecimal(
		// Integer.parseInt(id))));
...
//			entity.setSex(order.getSex().getValue());
//			entity.setCreatetime(order.getCreateTime());

			TOrder updateEntity = OrderConverter.toEntity(order);
			//除id属性外，将其它属性从updateEntity复制到entity上
			BeanUtils.copyProperties(updateEntity, entity, "id");
		}
